...
public class TicTacToeFrame extends javax.swing.JFrame {
    ...
    private void throwAlreadyExists() {
        ...
        JOptionPane.showMessageDialog(errorBox, "This place already holds a value! Try another cell", 
    ...
    private void checkDraw(){
        if(occupied==9)
        {
            if(!checkWin("O") && !checkWin("X")){
                ...
                JOptionPane.showMessageDialog(oWin, "Alas! This Match is a draw!", 
    ...
    private void xTurn(JButton btn){
        ...
        if(checkWin("X"))
        {
            ...
            JOptionPane.showMessageDialog(xWin, "Congratulations!!! Player 1 has won the match!", 
                "Game Over!", JOptionPane.PLAIN_MESSAGE);
    ...
    private void oTurn(JButton btn){
        ...
        if(checkWin("O")){
            ...
            scoreX.setText(Integer.toString(xCount));
            JFrame oWin=new JFrame("GAME OVER!");
            JOptionPane.showMessageDialog(oWin, "Congratulations!!! Player 2 has won the match!", 
                "Game Over!", JOptionPane.PLAIN_MESSAGE);
        }
        changeTurn();
    }
    ...
    private void btn33ActionPerformed(java.awt.event.ActionEvent evt) {                                      
        // TODO add your handling code here:
        if(!active)
        {
            return;
